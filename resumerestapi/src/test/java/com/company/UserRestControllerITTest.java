...
public class UserRestControllerITTest implements RestTemplateHolder {
 ...
 @Test
 public void greetingShouldResturnDefaultMessage() throws Exception {


  String url = "http://localhost:" +port+"/users/25";
  ...
  Assert.assertEquals("must equal 25",25L,Long.valueOf(hashMap.get("id")+"").longValue());
